...
public interface LancamentoService {
	...
	/**
	 * Remove um lançamento da base de dados usando o objeto.
	 * 
	 * @param lancamento
	 */
	void removerByObject(Lancamento lancamento);	
	
	/**
	 * Remove um lançamento da base de dados usando o id do objeto.
	 * 
	 * @param id
	 */
	void removerById(Long id);
}